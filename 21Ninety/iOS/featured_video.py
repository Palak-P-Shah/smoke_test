...
desired_cap = {
     ...
     'os': 'iOS',
    'name': 'BStack-[Python] Smoke Test for 21ninety.com featured video is as expected or not on ios safari',
...
def set_status():
    ...
    driver.execute_script(
      'browserstack_executor: {"action": "setSessionStatus", "arguments": '
      '{"status":"passed", "reason": ", for ios safari, on 21ninety.com featured video do work as expected"}}')
