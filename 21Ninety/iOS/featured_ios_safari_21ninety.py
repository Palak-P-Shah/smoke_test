...
desired_cap = {
     ...
     'os': 'iOS',
     'name': 'BStack-[Python] Smoke Test for 21ninety.com on ios safari for Featured Section',
...
def page_load():
    try:
        ...
        driver.execute_script(
          ...
          '{"status":"failed", "reason": for 21ninety.com, for ios safari, '
...
def set_status():
    ...
    driver.execute_script(
      ...
      ' 21ninety.com do work as expected on ios safari."}}')
