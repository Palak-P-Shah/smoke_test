...
desired_cap = {
    ...
    'os': 'Android',
    'name': 'BStack-[Python] Smoke Test for 21ninety.com search functionality is as expected or not on android chrome',
...
def verify_search(search_text):
    ...
    driver.execute_script(
      'browserstack_executor: {"action": "setSessionStatus", "arguments": '
      '{"status":"passed", "reason": ", for android chrome, on 21ninety.com search functionality with search text as:'+search_text+
      ' do work as expected"}}')
