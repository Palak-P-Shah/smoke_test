...
desired_cap = {
    ...
    'os': 'Android',
    'name': 'BStack-[Python] Smoke Test for 21ninety.com nav bar section is as expected or not on android chrome',
...
def set_status():
    ...
    driver.execute_script(
      'browserstack_executor: {"action": "setSessionStatus", "arguments": '
      '{"status":"passed", "reason": ", for android chrome, on 21ninety.com navigation section do work as expected"}}')
