...
desired_cap = {
  ...
  'os': 'Android',
   'name': 'BStack-[Python] Smoke Test for travelnoire.com most popular section is as expected on android chrome',
...
def set_status():
    ...
    driver.execute_script(
      'browserstack_executor: {"action": "setSessionStatus", "arguments": '
      '{"status":"passed", "reason": ", for android chrome, on travelnoire.com '
      'Most Popular section do work as expected"}}')
