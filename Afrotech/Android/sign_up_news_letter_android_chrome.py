...
desired_cap = {
    ...
    'os': 'Android',
    'name': 'BStack-[Python] Smoke Test for afrotech.com sign up for news letter working as expected on android chrome',
...
def set_status():
    ...
    driver.execute_script(
      'browserstack_executor: {"action": "setSessionStatus", "arguments": '
      '{"status":"passed", "reason": ", for android chrome, sign up for news letter section on the '
