...
desired_cap = {
   ...
   'os': 'Windows',
   'name': 'BStack-[Python] Smoke Test for afrotech.com for podcast is as expected on desktop',
...
def page_load():
    try:
        ...
        driver.execute_script(
          ...
          '{"status":"failed", "reason": for afrotech.com, for web, '
...
def set_status():
    ...
    driver.execute_script(
      'browserstack_executor: {"action": "setSessionStatus", "arguments": '
      '{"status":"passed", "reason": ", for desktop, on afrotech.com podcast do work as expected"}}')
