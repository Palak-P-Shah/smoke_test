...
desired_cap = {
   ...
   'os': 'Windows',
   'name': 'BStack-[Python] Smoke Test for afrotech.com Most Popular Section as expected on desktop',
...
def set_status():
    ...
    driver.execute_script(
      'browserstack_executor: {"action": "setSessionStatus", "arguments": '
      '{"status":"passed", "reason": ", for desktop, Most Popular section on the '
