...
def verify_blavity_footer():
    ...
    if all_rights_reserved.is_displayed():
        ...
        actions = ActionChains(driver)
        actions.move_to_element(fb_blavity).perform()
        ...
        actions = ActionChains(driver)
        actions.move_to_element(twitter_blavity).perform()
        ...
        actions = ActionChains(driver)
        actions.move_to_element(instag_blavity).perform()
        ...
        actions = ActionChains(driver)
        actions.move_to_element(link_careers).perform()
...
def set_status():
    ...
    driver.execute_script(
      'browserstack_executor: {"action": "setSessionStatus", "arguments": '
      '{"status":"passed", "reason": "in Android Chrome, '
