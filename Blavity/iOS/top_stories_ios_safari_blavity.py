...
desired_cap = {
  ...
  'os': 'iOS',
   'name': 'BStack-[Python] Smoke Test for blavity.com top stories section is as expected on ios safari',
...
def set_status():
    ...
    driver.execute_script(
      'browserstack_executor: {"action": "setSessionStatus", "arguments": '
      '{"status":"passed", "reason": ", for ios safari, on blavity.com top stories section do work as expected"}}')
